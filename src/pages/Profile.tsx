...
const Profile = () => {
  ...
  const [previewUrl, setPreviewUrl] = useState(userSix);
    ...
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-24 h-30 w-full max-w-30 rounded-full bg-white/20   backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <img src={previewUrl} alt="profile" className='w-34 h-30 md:w-40 md:h-40 -p-4 rounded-full'/>
              <label
                htmlFor="profile"
