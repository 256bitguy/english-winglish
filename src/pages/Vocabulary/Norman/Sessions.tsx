  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 items-center">
        <div className="shadow m-5 h-96 w-96 border border-secondary flex justify-between flex-col  p-4">
          <div className='flex justify-between'>
          <h1 className="text-2xl self-center">Session 1 </h1>
          <CircularProgress percentage={20}/>
          </div>
          <div>
          <h1 className="text-lg">
            This session will contain the following words{' '}
          </h1>
          <ol className='grid grid-cols-2 text-lg font-semibold'>
            <li>one</li>
            <li>one</li>
            <li>one</li>
            <li>one</li>
          ...
          <div className="flex justify-end ">
            <Link
              to="/vocabulary/norman/sessions"
              className="inline-flex items-center justify-center gap-2.5 rounded-md bg-primary  px-1 py-1.5 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10"
            >
              Continue
            </Link>
          </div>
        ...
        <div className="shadow m-5 h-96 w-96 border border-secondary flex justify-between flex-col  p-4">
          <div className='flex justify-between'>
          <h1 className="text-2xl self-center">Session 2 </h1>
          <CircularProgress percentage={20}/>
          </div>
          <div>
          <h1 className="text-lg">
        ...
        <div className="shadow m-5 h-96 w-96 border border-secondary flex justify-between flex-col  p-4">
          <div className='flex justify-between'>
          <h1 className="text-2xl self-center">Session 3 </h1>
          <CircularProgress percentage={20}/>
          </div>
          <div>
          <h1 className="text-lg">
